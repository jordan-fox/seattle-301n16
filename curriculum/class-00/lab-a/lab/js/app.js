...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the letiable declaration from `let to `const`.
  // The console log was looking for a global variable but rando had been defined in the while loop therefore it was a local only variable.
  console.log(viewed);
